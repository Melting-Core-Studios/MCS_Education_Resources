...
# OSIRIS-REx spacecraft NAIF ID is -74.
# (The spacecraft CK frame ID is typically spacecraft_ID * 1000 by NAIF convention; for OSIRIS-REx this would be -74000.)
# Launch: 2005-08-12 11:43:00 UTC
LAUNCH_TIME = "2016-09-08 23:05:00"
...
def main():
    ...
    out_root = repo_root / "NASA_Data" / "events_in_our_solar_system" / "output" / "osiris"
    ...
    # OSIRIS-REx (daily)
    t_sc, pv_sc, sig_sc = horizons_vectors_chunked(OSIRIS_REX_ID, LAUNCH_TIME, stop_time, "1 d")
    sc_json = {
        "schema": "mcs-ephem-v1",
        "t_jd": t_sc,
        "pv": pv_sc,
        "meta": {
            ...
            "object": {"name": "OSIRIS-REx", "spkid": OSIRIS_REX_ID},
            "signature": sig_sc,
        },
    }
    write_json(ephem_dir / "osiris_1d.json", sc_json)
    ...
    windows = [
        (
            ...
            "2016-09-09 02:00:00",
            "10 m",
            "osiris_launch_10m.json",
        ),
        (
            "osiris_earth_flyby_10m",
            "2017-09-22 00:00:00",
            "2017-09-23 00:00:00",
            "10 m",
            "osiris_earth_flyby_10m.json",
        ),
        (
            "osiris_tag_1m",
            "2020-10-20 00:00:00",
        ...
        (
            "osiris_sample_return_10m",
            "2023-09-24 00:00:00",
            "2023-09-25 00:00:00",
            "10 m",
            "osiris_sample_return_10m.json",
        ),

    ]

    for ds_id, s, e, step, fn in windows:
        t_hi, pv_hi, sig_hi = horizons_vectors_chunked(OSIRIS_REX_ID, s, e, step)
        hi_json = {
            "schema": "mcs-ephem-v1",
            "t_jd": t_hi,
            "pv": pv_hi,
    ...
    manifest = {
        ...
        "datasets": [
            ...
            {"id": "osiris_1d", "file": "ephemeris/osiris_1d.json"},
            {"id": "osiris_launch_10m", "file": "ephemeris/osiris_launch_10m.json"},
            {"id": "osiris_mars_orbit_insertion_10m", "file": "ephemeris/osiris_mars_orbit_insertion_10m.json"},
            {"id": "osiris_aerobraking_end_10m", "file": "ephemeris/osiris_aerobraking_end_10m.json"},
            {"id": "osiris_first_mapping_orbit_10m", "file": "ephemeris/osiris_first_mapping_orbit_10m.json"},
        ],
    }
