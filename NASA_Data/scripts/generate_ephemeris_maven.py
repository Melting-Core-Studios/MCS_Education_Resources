...
# MAVEN spacecraft NAIF ID is -74.
# (The spacecraft CK frame ID is typically spacecraft_ID * 1000 by NAIF convention; for MAVEN this would be -74000.)
# Launch: 2005-08-12 11:43:00 UTC
LAUNCH_TIME = "2013-11-18 18:28:00"
...
def main():
    ...
    out_root = repo_root / "NASA_Data" / "events_in_our_solar_system" / "output" / "maven"
    ...
    # MAVEN (daily)
    t_sc, pv_sc, sig_sc = horizons_vectors_chunked(MAVEN_ID, LAUNCH_TIME, stop_time, "1 d")
    sc_json = {
        "schema": "mcs-ephem-v1",
        "t_jd": t_sc,
        "pv": pv_sc,
        "meta": {
            ...
            "object": {"name": "MAVEN", "spkid": MAVEN_ID},
            "signature": sig_sc,
        },
    }
    write_json(ephem_dir / "maven_1d.json", sc_json)
    ...
    windows = [
        (
            ...
            "2013-11-18 20:00:00",
            "10 m",
            "maven_launch_10m.json",
        ),
        (
            "maven_mars_orbit_insertion_10m",
            "2014-09-22 00:00:00",
            "2014-09-22 06:00:00",
            "10 m",
            "maven_mars_orbit_insertion_10m.json",
        ),
        (
            "maven_siding_spring_10m",
            "2014-10-19 00:00:00",
            "2014-10-20 00:00:00",
            "10 m",
            "maven_siding_spring_10m.json",
        ),

    ]

    for ds_id, s, e, step, fn in windows:
        t_hi, pv_hi, sig_hi = horizons_vectors_chunked(MAVEN_ID, s, e, step)
        hi_json = {
            "schema": "mcs-ephem-v1",
            "t_jd": t_hi,
            "pv": pv_hi,
    ...
    manifest = {
        ...
        "datasets": [
            ...
            {"id": "maven_1d", "file": "ephemeris/maven_1d.json"},
            {"id": "maven_launch_10m", "file": "ephemeris/maven_launch_10m.json"},
            {"id": "maven_mars_orbit_insertion_10m", "file": "ephemeris/maven_mars_orbit_insertion_10m.json"},
            {"id": "maven_aerobraking_end_10m", "file": "ephemeris/maven_aerobraking_end_10m.json"},
            {"id": "maven_first_mapping_orbit_10m", "file": "ephemeris/maven_first_mapping_orbit_10m.json"},
        ],
    }
