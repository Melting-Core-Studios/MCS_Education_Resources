...
# 2001 Mars Odyssey spacecraft NAIF ID is -53.
# (The Odyssey spacecraft CK frame ID is -53000, which follows NAIF convention: CK_ID = spacecraft_ID * 1000.)
# Launch: 2001-04-07 15:02:22 UTC
LAUNCH_TIME = "2001-04-07 15:02:22"
...
def main():
    ...
    # Mars Odyssey (daily)
    t_sc, pv_sc, sig_sc = horizons_vectors_chunked(ODYSSEY_ID, LAUNCH_TIME, stop_time, "1 d")
    sc_json = {
        "schema": "mcs-ephem-v1",
        "t_jd": t_sc,
        "pv": pv_sc,
        "meta": {
            ...
            "object": {"name": "Mars Odyssey", "spkid": ODYSSEY_ID},
            "signature": sig_sc,
        },
    }
    write_json(ephem_dir / "mars_odyssey_1d.json", sc_json)

    # Higher-resolution windows for key milestones (kept compact)
    windows = [
        (
            "mars_odyssey_launch_10m",
            "2001-04-07 14:00:00",
            "2001-04-07 18:00:00",
            "10 m",
            "mars_odyssey_launch_10m.json",
        ),
        (
            "mars_odyssey_moi_10m",
            "2001-10-24 01:00:00",
            "2001-10-24 04:00:00",
            "10 m",
            "mars_odyssey_moi_10m.json",
        ),
        (
            "mars_odyssey_themis_first_light_10m",
            "2001-10-30 12:00:00",
            "2001-10-30 15:00:00",
            "10 m",
            "mars_odyssey_themis_first_light_10m.json",
        ),
    ]

    for ds_id, s, e, step, fn in windows:
        t_hi, pv_hi, sig_hi = horizons_vectors_chunked(ODYSSEY_ID, s, e, step)
        hi_json = {
            "schema": "mcs-ephem-v1",
            "t_jd": t_hi,
            "pv": pv_hi,
    ...
    manifest = {
        ...
        "datasets": [
            ...
            {"id": "mars_odyssey_1d", "file": "ephemeris/mars_odyssey_1d.json"},
            {"id": "mars_odyssey_launch_10m", "file": "ephemeris/mars_odyssey_launch_10m.json"},
            {"id": "mars_odyssey_moi_10m", "file": "ephemeris/mars_odyssey_moi_10m.json"},
            {"id": "mars_odyssey_themis_first_light_10m", "file": "ephemeris/mars_odyssey_themis_first_light_10m.json"},
        ],
    }
